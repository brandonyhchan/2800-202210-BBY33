...
INSERT INTO BBY_33_user (USER_ID, user_name, first_name, last_name, email_address, admin_user, charity_user, user_removed, user_image, password) VALUES (5, 'Patrick', 'Patrick', 'Guichon', 'pg@gmail.com', 'n', 'y', 'n', 'stock-profile.png', '$2b$05$ANUilSI2BHfA71wdbijQZ.1upZyewQ2EAPOZUj.FmvcJJsqXgwgY.');
...
INSERT INTO BBY_33_package (PACKAGE_ID, country_id, package_name, package_price, description_of_package, package_image, package_info, package_destination) VALUES (7, 2, 'Afghanistan Package 2', 50, 'Contains non-perishable food, clothing and women''s products', '/img/landing1.jpg', 'Afghanistan Package 2 was curated by Afghan Charity Organisation, containing non-perishable food, children''s clothing, and women''s hygiene products. This care package
will be distributed to a family that has been displaced by due to war.', 'Afghanistan');
